...
class UScriptStruct* FHoudiniExtents::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HoudiniExtents.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniExtents, Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniExtents"));
	}
...
class UScriptStruct* FHoudiniDataLayer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HoudiniDataLayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniDataLayer, Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniDataLayer"));
	}
...
template<> HOUDINIENGINERUNTIME_API UScriptStruct* StaticStruct<FHoudiniOutputObject>()
{
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_OutputObjects = { "OutputObjects", nullptr, (EPropertyFlags)0x0020080000200000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UHoudiniOutput, OutputObjects), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_OutputObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniOutput_Statics::NewProp_OutputObjects_MetaData)) }; // 3466299402 3064350937
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cygwin_home_prisms_builder_new_Nightly19_5CMake_dev_engine_unreal_5_1_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ScriptStructInfo[] = {
		...
		{ FHoudiniBakedOutputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniBakedOutputObject_Statics::NewStructOps, TEXT("HoudiniBakedOutputObject"), &Z_Registration_Info_UScriptStruct_HoudiniBakedOutputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniBakedOutputObject), 3294771944U) },
		{ FHoudiniBakedOutput::StaticStruct, Z_Construct_UScriptStruct_FHoudiniBakedOutput_Statics::NewStructOps, TEXT("HoudiniBakedOutput"), &Z_Registration_Info_UScriptStruct_HoudiniBakedOutput, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniBakedOutput), 3249964753U) },
		...
		{ FHoudiniOutputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniOutputObject_Statics::NewStructOps, TEXT("HoudiniOutputObject"), &Z_Registration_Info_UScriptStruct_HoudiniOutputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniOutputObject), 3064350937U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cygwin_home_prisms_builder_new_Nightly19_5CMake_dev_engine_unreal_5_1_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UHoudiniLandscapeTargetLayerOutput, UHoudiniLandscapeTargetLayerOutput::StaticClass, TEXT("UHoudiniLandscapeTargetLayerOutput"), &Z_Registration_Info_UClass_UHoudiniLandscapeTargetLayerOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniLandscapeTargetLayerOutput), 1740383658U) },
		...
		{ Z_Construct_UClass_UHoudiniOutput, UHoudiniOutput::StaticClass, TEXT("UHoudiniOutput"), &Z_Registration_Info_UClass_UHoudiniOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniOutput), 257606504U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cygwin_home_prisms_builder_new_Nightly19_5CMake_dev_engine_unreal_5_1_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniOutput_h_1111612856(TEXT("/Script/HoudiniEngineRuntime"),
